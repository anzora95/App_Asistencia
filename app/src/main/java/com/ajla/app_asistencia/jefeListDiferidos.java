...
public class jefeListDiferidos extends AppCompatActivity implements Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    String cod_oferta,carnet_AlumDi,nom_alumDif,apel_alumDif,codigo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listadif.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                // nom_alumDif=listadoDife.get(position).getCarnet().toString();
                //  apel_alumDif=listadoDife.get(position).getCarnet().toString();
                ...
                //  oferta.putExtra("nomAlumDif",nom_alumDif);
                // oferta.putExtra("apelAlumDif",apel_alumDif);
    ...
    public void onResponse(JSONObject response) {
        ...
        try {
            ...
            for (int i=0;i<json.length();i++){
                ...
                soliDife.setId_solicitud(jsonObject.optString("ID_SOLICITUD"));
