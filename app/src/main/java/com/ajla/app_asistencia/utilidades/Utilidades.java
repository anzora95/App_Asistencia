...
public class Utilidades {
    ...
    public static final String CREAR_TABLA_ALUMNO ="CREATE TABLE "+TABLA_ALUMNO+" ("+CAMPO_CARNET+" CHAR(7) PRIMARY KEY,"+CAMPO_NOMBRE+" VARCHAR(40), "+CAMPO_APELLIDO+" VARCHAR(40), "+CAMPO_CONTRA_ALUMNO+" VARCHAR(10))";
  ...
  //Constantes campos tabla Administrador
    ...
    public static final String CREAR_TABLA_ADMINISTRADOR ="CREATE TABLE "+TABLA_ADMINISTRADOR+" ("+CAMPO_USUARIO+" CHAR(7) PRIMARY KEY,"+CAMPO_CONTRA_ADMIN+" VARCHAR(10))";
    ...
    public static final String CREAR_TABLA_AREA ="CREATE TABLE "+TABLA_AREA+" ("+CAMPO_COD_AREA+" CHAR(8) PRIMARY KEY,"+CAMPO_NOM_AREA+" VARCHAR(40))";
    ...
    public static final String CREAR_TABLA_CICLO ="CREATE TABLE "+TABLA_CICLO+" ("+CAMPO_ESTADO+" VARCHAR(1),"+CAMPO_CICLO_ANIO+" VARCHAR(6)PRIMARY KEY)";
    ...
    public static final String CREAR_TABLA_DOCENTE ="CREATE TABLE "+TABLA_DOCENTE+" ("+CAMPO_ISSS+" CHAR(9) PRIMARY KEY,"+CAMPO_NOM_DOCE+" VARCHAR(40),"+CAMPO_APE_DOCE+" VARCHAR(40),"+CAMPO_CONTRA_DOCE+" INTEGER)";
    ...
    public static final String CREAR_TABLA_INSCRIPCION_TEO ="CREATE TABLE "+TABLA_INSCRIPCION_TEO+" ("+CAMPO_ID_INSTEO+" INTEGER PRIMARY KEY AUTOINCREMENT,"+CAMPO_CARNET_INS_TEO+" CHAR(7))";
    ...
    public static final String CREAR_TABLA_INSCRIPCION_LAB ="CREATE TABLE "+TABLA_INSCRIPCION_LAB+" ("+CAMPO_ID_INSLAB+" INTEGER PRIMARY KEY AUTOINCREMENT,"+CAMPO_CARNET_INS_LAB+" CHAR(7))";
    ...
    public static final String CREAR_TABLA_JEFE_DEPARTAMENTO ="CREATE TABLE "+TABLA_JEFE_DEPARTAMENTO+" ("+CAMPO_COD_AREA_JEFE+" CHAR(8),"+CAMPO_ISSS_JEFE+" CHAR(9) PRIMARY KEY,"+CAMPO_PERIODO+" CHAR(7) PRIMARY KEY,"+CAMPO_CONTRA_JEFE+" VARCHAR(10))";
    ...
    public static final String CREAR_TABLA_LUGAR ="CREATE TABLE "+TABLA_LUGAR+" ("+CAMPO_COD_LUGAR+" VARCHAR(5) PRIMARY KEY,"+CAMPO_CAPACIDAD+" INTEGER,"+CAMPO_TIPO+" CHAR(1))";
    ...
    public static final String CREAR_TABLA_MATERIA ="CREATE TABLE "+TABLA_MATERIA+" ("+CAMPO_COD_MATERIA+" CHAR(6) PRIMARY KEY,"+CAMPO_COD_AREA_MATE+" CHAR(8),"+CAMPO_NOM_MATERIA+" VARCHAR(40))";
    ...
    public static final String CREAR_TABLA_OFERTA_MATE ="CREATE TABLE "+TABLA_OFERTA_MATE+" ("+CAMPO_COD_OFER_MATE+" INTEGER PRIMARY KEY AUTOINCREMENT,"+CAMPO_COD_MATERIA_OFERMA+" CHAR(6),"+CAMPO_ISSS_OFERMA+" CHAR(9),"+CAMPO_CICLO_ANIO_OFERMA+" VARCHAR(6))";
    ...
    public static final String CREAR_TABLA_OFERTA_LAB ="CREATE TABLE "+TABLA_OFERTA_LAB+" ("+CAMPO_ID_OFER_LAB+" INTEGER PRIMARY KEY AUTOINCREMENT,"+CAMPO_COD_LUGAR_OFERLAB+" VARCHAR(5),"+CAMPO_COD_OFER_MATE_OFERLAB+" INTEGER,"+CAMPO_ISSS_OFERLAB+" CHAR(9),"+CAMPO_NUM_GRUPO_LAB+" CHAR(2))";
    ...
    public static final String CREAR_TABLA_ASIS_LAB ="CREATE TABLE "+TABLA_ASIS_LAB+" ("+CAMPO_FECHA_LAB+" DATE PRIMARY KEY,"+CAMPO_ID_OFER_LAB_ASISLAB+" INTEGER)";
    ...
    public static final String CREAR_TABLA_CONTROL_LAB ="CREATE TABLE "+TABLA_CONTROL_LAB+" ("+CAMPO_FECHA_LAB_CONTROL+" DATE PRIMARY KEY,"+CAMPO_ID_INSLAB_CONTROL+" INTEGER PRIMARY KEY,"+CAMPO_ASITENCIA_LAB+" CHAR(1))";
    ...
    public static final String CREAR_TABLA_ASIS_EXAM ="CREATE TABLE "+TABLA_ASIS_EXAM+" ("+CAMPO_FECHA_EXAM+" DATE PRIMARY KEY,"+CAMPO_COD_OFER_MATE_ASISEXA+" INTEGER,"+CAMPO_COD_EVA+",VARCHAR(6))";
    ...
    public static final String CREAR_TABLA_CONTROL_EXAM ="CREATE TABLE "+TABLA_CONTROL_EXAM+" ("+CAMPO_FECHA_EXAM_CONTROL+" DATE PRIMARY KEY,"+CAMPO_CARNET_CONTROL_EXAM+" CHAR(7),"+CAMPO_ASISTENCIA_EXAM+" CHAR(1))";
    ...
    public static final String CREAR_TABLA_OFERTA_TEO ="CREATE TABLE "+TABLA_OFERTA_TEO+" ("+CAMPO_ID_OFER_TEO+" INTEGER PRIMARY KEY AUTOINCREMENT,"+CAMPO_COD_LUGAR_OFERTEO+" VARCHAR(5),"+CAMPO_COD_OFER_MATE_OFERTEO+" INTEGER,"+CAMPO_ISSS_OFERTEO+" CHAR(9),"+CAMPO_NUM_GRUPO_TEO+" CHAR(2))";
    ...
    public static final String CREAR_TABLA_ASIS_TEO ="CREATE TABLE "+TABLA_ASIS_TEO+" ("+CAMPO_FECHA_TEO+" DATE PRIMARY KEY,"+CAMPO_ID_OFER_TEO_ASISTEO+" INTEGER)";
    ...
    public static final String CREAR_TABLA_CONTROL_TEO ="CREATE TABLE "+TABLA_CONTROL_TEO+" ("+CAMPO_FECHA_TEO_CONTROL+" DATE PRIMARY KEY,"+CAMPO_ID_INSTEO_CONTROL+" INTEGER PRIMARY KEY,"+CAMPO_ASITENCIA_TEO+" CHAR(1))";
    ...
    public static final String CREAR_TABLA_OPCIONCRUD ="CREATE TABLE "+TABLA_OPCIONCRUD+" ("+CAMPO_IDOPCION+" INTEGER PRIMARY KEY AUTOINCREMENT,"+CAMPO_DESOPCION+" VARCHAR(30),"+CAMPO_NUMCRUD+" INTEGER)";
    ...
    public static final String CREAR_TABLA_SOLICITUD_DIFERIDO ="CREATE TABLE "+TABLA_SOLICITUD_DIFERIDO+" ("+CAMPO_ID_SOLICITUD+" INTEGER PRIMARY KEY AUTOINCREMENT,"+CAMPO_CARNET_SOLDI+" CHAR(7),"+CAMPO_ISSS_SOLDI+" CHAR(9),"+CAMPO_PERIODO_SOLDI+" CHAR(7),"+CAMPO_FECHA_EXAM_SOLDI+" DATE,"+CAMPO_ESTADODIFE+" VARCHAR(1))";
    ...
    public static final String CREAR_TABLA_USUARIO ="CREATE TABLE "+TABLA_USUARIO+" ("+CAMPO_IDUSUARIO+" INTEGER PRIMARY KEY AUTOINCREMENT,"+CAMPO_NOMUSUARIO+" VARCHAR(30),"+CAMPO_CLAVE+" CHAR(5))";
    ...
    public static final String CREAR_TABLA_ACESSOUSUARIO ="CREATE TABLE "+TABLA_ACESSOUSUARIO+" ("+CAMPO_IDUSUARIO_ACCESO+" INTEGER PRIMARY KEY,"+CAMPO_IDOPCION_ACCESO+" INTEGER PRIMARY KEY)";
