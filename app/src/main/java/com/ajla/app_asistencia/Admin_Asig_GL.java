...
public class Admin_Asig_GL extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sp_gl=(Spinner) findViewById(R.id.spinnerGL);
        sp_doce=(Spinner)findViewById(R.id.spinnerDocenteGL);
        sp_local=(Spinner) findViewById(R.id.spinnerLocalGL);
        ...
        ArrayAdapter<CharSequence> adaptador1= ArrayAdapter.createFromResource(this,R.array.listalabdis,android.R.layout.simple_spinner_item);
    ...
    private void consultarlistalocales() {
        ...
        SQLiteDatabase db=conec.getReadableDatabase();
        String sql ="Select * from lugar where tipo='L'";
