...
public class ConexionSQLiteHelper extends SQLiteOpenHelper {
    ...
    public static abstract class DatosTabla implements BaseColumns {
        ...
        public static final String CAMPO_ESTADO2="estado2";
        ...
        private static final String CREAR_TABLA_CICLO ="CREATE TABLE "+DatosTabla.TABLA_CICLO+" ("+DatosTabla.CAMPO_ESTADO+" VARCHAR(1) NOT NULL,"+DatosTabla.CAMPO_CICLO_ANIO+" INTEGER PRIMARY KEY AUTOINCREMENT, "+DatosTabla.CAMPO_ESTADO2+" VARCHAR(1) NOT NULL)";
        ...
        private static final String CREAR_TABLA_OFERTA_MATE ="CREATE TABLE "+DatosTabla.TABLA_OFERTA_MATE+" ("+DatosTabla.CAMPO_COD_OFER_MATE+" INTEGER PRIMARY KEY AUTOINCREMENT,"+CAMPO_COD_MATERIA_OFERMA+" CHAR(6) NOT NULL,"+CAMPO_ISSS_OFERMA+" CHAR(9) NOT NULL,"+CAMPO_CICLO_ANIO_OFERMA+" INTEGER NOT NULL,"+"CONSTRAINT fk_Materia_v FOREIGN KEY (cod_materia) REFERENCES materia(cod_materia),"+"CONSTRAINT fk_Materia_v1 FOREIGN KEY (isss) REFERENCES docente(isss),"+"CONSTRAINT fk_Materia_v2 FOREIGN KEY (ciclo_anio) REFERENCES ciclo(ciclo_anio))";
